...
object FfiConverterTypeFlorestad: FfiConverter<Florestad, Pointer> {
...
data class Config (
    ...
    var `cfilterTypes`: List<FilterType>, 
    var `logToStdout`: Boolean, 
    var `network`: Network = Network.BITCOIN, 
    var `dataDir`: String? = null, 
    var `walletXpub`: List<String>? = null, 
    var `walletDescriptor`: List<String>? = null, 
    var `rescan`: UInt? = null, 
    var `logToFile`: Boolean = false, 
    var `assumeValid`: String? = null, 
    var `configFile`: String? = null, 
    var `proxy`: String? = null, 
    var `connect`: String? = null, 
    var `jsonRpcAddress`: String? = null, 
...
object FfiConverterTypeConfig: FfiConverterRustBuffer<Config> {
    override fun read(buf: ByteBuffer): Config {
        return Config(
            ...
            FfiConverterSequenceTypeFilterType.read(buf),
            FfiConverterBoolean.read(buf),
    ...
    override fun allocationSize(value: Config) = (
            ...
            FfiConverterSequenceTypeFilterType.allocationSize(value.`cfilterTypes`) +
            ...
            FfiConverterOptionalUInt.allocationSize(value.`rescan`) +
            FfiConverterBoolean.allocationSize(value.`logToFile`) +
            FfiConverterOptionalString.allocationSize(value.`assumeValid`) +
            FfiConverterOptionalString.allocationSize(value.`configFile`) +
            FfiConverterOptionalString.allocationSize(value.`proxy`) +
            FfiConverterOptionalString.allocationSize(value.`connect`) +
    ...
    override fun write(value: Config, buf: ByteBuffer) {
            ...
            FfiConverterSequenceTypeFilterType.write(value.`cfilterTypes`, buf)
            ...
            FfiConverterOptionalUInt.write(value.`rescan`, buf)
            FfiConverterBoolean.write(value.`logToFile`, buf)
            FfiConverterOptionalString.write(value.`assumeValid`, buf)
            FfiConverterOptionalString.write(value.`configFile`, buf)
            FfiConverterOptionalString.write(value.`proxy`, buf)
            FfiConverterOptionalString.write(value.`connect`, buf)
...
object FfiConverterTypeFilterType: FfiConverterRustBuffer<FilterType> {
    override fun read(buf: ByteBuffer) = try {
        FilterType.values()[buf.int - 1]
    } catch (e: IndexOutOfBoundsException) {
        throw RuntimeException("invalid enum value, something is very wrong!!", e)
    }

    override fun allocationSize(value: FilterType) = 4

    override fun write(value: FilterType, buf: ByteBuffer) {
...
object FfiConverterOptionalUInt: FfiConverterRustBuffer<UInt?> {
    override fun read(buf: ByteBuffer): UInt? {
        if (buf.get().toInt() == 0) {
            return null
        }
...
object FfiConverterOptionalSequenceString: FfiConverterRustBuffer<List<String>?> {
...
object FfiConverterSequenceTypeFilterType: FfiConverterRustBuffer<List<FilterType>> {
    override fun read(buf: ByteBuffer): List<FilterType> {
        val len = buf.int
        return List<FilterType>(len) {
            FfiConverterTypeFilterType.read(buf)
        }
    }

    override fun allocationSize(value: List<FilterType>): Int {
        val sizeForLength = 4
        val sizeForItems = value.map { FfiConverterTypeFilterType.allocationSize(it) }.sum()
        return sizeForLength + sizeForItems
    }

    override fun write(value: List<FilterType>, buf: ByteBuffer) {
        buf.putInt(value.size)
        value.forEach {
            FfiConverterTypeFilterType.write(it, buf)
        }
    }
}
